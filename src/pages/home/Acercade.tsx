  ...
  return (
    <section id="acercade">
      <div className="relative w-full max-w-7xl mx-auto lg:flex items-center px-14 py-14">
        <div className="text-primary pt-12 lg:pt-0 lg:w-1/2">
        ...
        <div className="relative text-primary lg:w-1/2 lg:pl-12">
          <ImageComponent src="/images/pic1.png" alt="Imagen casas" />
          <div className="absolute right-0 -bottom-20 flex justify-end">
